...
class SevaPolicy
{
    ...
    {
        return $adminUser->can('view_any_seva');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Seva $seva): bool
    {
        return $adminUser->can('view_seva');
    }
    ...
    {
        return $adminUser->can('create_seva');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Seva $seva): bool
    {
        return $adminUser->can('update_seva');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Seva $seva): bool
    {
        return $adminUser->can('delete_seva');
    }
    ...
    {
        return $adminUser->can('delete_any_seva');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, Seva $seva): bool
    {
        return $adminUser->can('force_delete_seva');
    }
    ...
    {
        return $adminUser->can('force_delete_any_seva');
    }

    /**
     * Determine whether the adminUser can restore.
     */
    public function restore(AdminUser $adminUser, Seva $seva): bool
    {
        return $adminUser->can('restore_seva');
    }
    ...
    {
        return $adminUser->can('restore_any_seva');
    }

    /**
     * Determine whether the adminUser can replicate.
     */
    public function replicate(AdminUser $adminUser, Seva $seva): bool
    {
        return $adminUser->can('replicate_seva');
    }
    ...
    {
        return $adminUser->can('reorder_seva');
    }
}
