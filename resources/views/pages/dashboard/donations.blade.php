...
<section class="bg-temple-light border-b border-amber-900/20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p class="mt-2 divine-subtext">Tamara badha donations ni list</p>
    </div>
</section>
    ...
    <div class="card-sacred overflow-hidden">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-amber-900/15 border-b border-amber-900/20">
                        <tr>
                            ...
                            <th class="text-left px-5 py-3.5 text-xs font-semibold text-amber-600 uppercase tracking-wider">Type</th>
                            <th class="text-left px-5 py-3.5 text-xs font-semibold text-amber-600 uppercase tracking-wider">Purpose</th>
                            <th class="text-left px-5 py-3.5 text-xs font-semibold text-amber-600 uppercase tracking-wider">Receipt</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-amber-900/15">
                        ...
                        <tr class="hover:bg-amber-900/10 transition">
                            ...
                            <td class="px-5 py-4 font-bold text-gold">₹{{ number_format($donation->amount) }}</td>
                            <td class="px-5 py-4">
                            ...
                            <td class="px-5 py-4 text-amber-100/50 max-w-xs truncate">
                                {{ $donation->purpose ?? $donation->notes ?? '—' }}
                            </td>
                            <td class="px-5 py-4">
                                @if($donation->receipt_number)
                                    <a href="{{ route('dashboard.receipts.download', $donation->id) }}"
        ...
        @else
            <div class="text-center py-16">
                ...
                <p class="text-amber-100/30 mb-4">Tamara koi donations record nathi.</p>
