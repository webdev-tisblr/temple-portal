    ...
    private function seedCategories(): array
    {
        $categoryData = [
            'vastra' => [
                ...
                'description' => 'શ્રી પાતાળિયા હનુમાનજી મંદિરમાં ભગવાનને અર્પણ કરવા માટેના પવિત્ર વસ્ત્રો અને શ્રૃંગાર સામગ્રી.',
                'sort_order' => 1,
                'is_active' => true,
            ],
            'prasad' => [
    ...
    private function seedVastraProducts(ProductCategory $category): void
    {
        $products = [
            [
                ...
                'description_gu' => 'શ્રી પાતાળિયા હનુમાનજી મંદિરમાં ભગવાનને અર્પણ કરવા માટેનો લાલ રંગનો પવિત્ર વસ્ત્ર. શુદ્ધ કોટન કાપડમાંથી બનાવેલ, ઝરી બોર્ડર સાથે.',
                'description_hi' => 'श्री पातालिया हनुमानजी मंदिर में भगवान को अर्पण करने के लिए लाल रंग का पवित्र वस्त्र. शुद्ध कॉटन कपड़े से बना, ज़री बॉर्डर के साथ.',
                'description_en' => 'Sacred red garment for offering to Hanumanji at Shree Patadiya Hanumanji Temple. Made from pure cotton fabric with zari border.',
                'price' => 1100.00,
                'is_featured' => true,
                'sort_order' => 1,
            ],
    ...
    private function seedPrasadProducts(ProductCategory $category): void
    {
        $products = [
            [
                ...
                'description_gu' => 'શ્રી પાતાળિયા હનુમાનજી મંદિરના પવિત્ર પેંડા પ્રસાદ. શુદ્ધ ઘી અને ખાંડથી બનાવેલ, 250 ગ્રામ પેકિંગ.',
                'description_hi' => 'श्री पातालिया हनुमानजी मंदिर का पवित्र पेड़ा प्रसाद. शुद्ध घी और चीनी से बना, 250 ग्राम पैकिंग.',
                'description_en' => 'Sacred peda prasad from Shree Patadiya Hanumanji Temple. Made with pure ghee and sugar, 250gm packing.',
                'price' => 199.00,
                'is_featured' => false,
                'sort_order' => 1,
            ],
            [
                ...
                'description_gu' => 'શ્રી પાતાળિયા હનુમાનજી મંદિરના પવિત્ર પેંડા પ્રસાદ. શુદ્ધ ઘી અને ખાંડથી બનાવેલ, 500 ગ્રામ ફેમિલી પેક.',
                'description_hi' => 'श्री पातालिया हनुमानजी मंदिर का पवित्र पेड़ा प्रसाद. शुद्ध घी और चीनी से बना, 500 ग्राम फैमिली पैक.',
                'description_en' => 'Sacred peda prasad from Shree Patadiya Hanumanji Temple. Made with pure ghee and sugar, 500gm family pack.',
                'price' => 349.00,
                'is_featured' => false,
                'sort_order' => 2,
            ],
            [
                ...
                'description_gu' => 'શ્રી પાતાળિયા હનુમાનજી મંદિરના પવિત્ર પેંડા પ્રસાદ. શુદ્ધ ઘી અને ખાંડથી બનાવેલ, 1 કિલો મોટું પેકિંગ — કુટુંબ અને સગાંવહાલાં માટે.',
                'description_hi' => 'श्री पातालिया हनुमानजी मंदिर का पवित्र पेड़ा प्रसाद. शुद्ध घी और चीनी से बना, 1 किलो बड़ी पैकिंग — परिवार और रिश्तेदारों के लिए.',
                'description_en' => 'Sacred peda prasad from Shree Patadiya Hanumanji Temple. Made with pure ghee and sugar, 1kg large packing — for family and relatives.',
                'price' => 649.00,
                'is_featured' => false,
                'sort_order' => 3,
            ],
    ...
    private function seedBookProducts(ProductCategory $category): void
    {
        $products = [
            [
                ...
                'description_gu' => 'સુંદર ચિત્રો સાથેનું હનુમાન ચાલીસા પુસ્તક. ગુજરાતી અર્થ અને ટીકા સહિત. શ્રી પાતાળિયા હનુમાનજી મંદિર દ્વારા પ્રકાશિત.',
                'description_hi' => 'सुंदर चित्रों के साथ हनुमान चालीसा पुस्तक. गुजराती अर्थ और टीका सहित. श्री पातालिया हनुमानजी मंदिर द्वारा प्रकाशित.',
                'description_en' => 'Hanuman Chalisa book with beautiful illustrations. Including Gujarati meaning and commentary. Published by Shree Patadiya Hanumanji Temple.',
                'price' => 151.00,
                'is_featured' => false,
                'sort_order' => 1,
            ],
    ...
    private function seedPoojaProducts(ProductCategory $category): void
    {
        $products = [
            ...
            [
                ...
                'description_gu' => 'શ્રી પાતાળિયા હનુમાનજીની મૂર્તિનો સુંદર ફોટો ફ્રેમ — 6×8 ઈંચ. ઘર અને ઓફિસમાં મૂકવા માટે, ગોલ્ડ કલરની ફ્રેમ.',
                'description_hi' => 'श्री पातालिया हनुमानजी की मूर्ति का सुंदर फोटो फ्रेम — 6×8 इंच. घर और ऑफिस में रखने के लिए, गोल्ड कलर की फ्रेम.',
                'description_en' => 'Beautiful photo frame of Shree Patadiya Hanumanji\'s murti — 6x8 inches. For home and office display, gold coloured frame.',
                'price' => 399.00,
                'is_featured' => false,
                'sort_order' => 4,
            ],
            [
                ...
                'description_gu' => 'શ્રી પાતાળિયા હનુમાનજીની મૂર્તિનો મોટો ફોટો ફ્રેમ — 12×16 ઈંચ. પૂજા ઘર માટે ઉત્તમ, પ્રિમિયમ વૂડન ફ્રેમ.',
                'description_hi' => 'श्री पातालिया हनुमानजी की मूर्ति का बड़ा फोटो फ्रेम — 12×16 इंच. पूजा घर के लिए उत्तम, प्रीमियम वुडन फ्रेम.',
                'description_en' => 'Large photo frame of Shree Patadiya Hanumanji\'s murti — 12x16 inches. Ideal for prayer room, premium wooden frame.',
                'price' => 799.00,
                'is_featured' => false,
                'sort_order' => 5,
            ],
