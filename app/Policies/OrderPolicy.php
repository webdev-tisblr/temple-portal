...
class OrderPolicy
{
    ...
    {
        return $adminUser->can('view_any_order');
    }
    ...
    {
        return $adminUser->can('view_order');
    }
    ...
    {
        return $adminUser->can('create_order');
    }
    ...
    {
        return $adminUser->can('update_order');
    }
    ...
    {
        return $adminUser->can('delete_order');
    }
    ...
    {
        return $adminUser->can('delete_any_order');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, Order $order): bool
    {
        return $adminUser->can('force_delete_order');
    }
    ...
    {
        return $adminUser->can('force_delete_any_order');
    }

    /**
     * Determine whether the adminUser can restore.
     */
    public function restore(AdminUser $adminUser, Order $order): bool
    {
        return $adminUser->can('restore_order');
    }
    ...
    {
        return $adminUser->can('restore_any_order');
    }

    /**
     * Determine whether the adminUser can replicate.
     */
    public function replicate(AdminUser $adminUser, Order $order): bool
    {
        return $adminUser->can('replicate_order');
    }
    ...
    {
        return $adminUser->can('reorder_order');
    }
}
