...
class EventPolicy
{
    ...
    {
        return $adminUser->can('view_any_event');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Event $event): bool
    {
        return $adminUser->can('view_event');
    }
    ...
    {
        return $adminUser->can('create_event');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Event $event): bool
    {
        return $adminUser->can('update_event');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Event $event): bool
    {
        return $adminUser->can('delete_event');
    }
    ...
    {
        return $adminUser->can('delete_any_event');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, Event $event): bool
    {
        return $adminUser->can('force_delete_event');
    }
    ...
    {
        return $adminUser->can('force_delete_any_event');
    }

    /**
     * Determine whether the adminUser can restore.
     */
    public function restore(AdminUser $adminUser, Event $event): bool
    {
        return $adminUser->can('restore_event');
    }
    ...
    {
        return $adminUser->can('restore_any_event');
    }

    /**
     * Determine whether the adminUser can replicate.
     */
    public function replicate(AdminUser $adminUser, Event $event): bool
    {
        return $adminUser->can('replicate_event');
    }
    ...
    {
        return $adminUser->can('reorder_event');
    }
}
