...
class HallPolicy
{
    ...
    {
        return $adminUser->can('view_any_hall');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Hall $hall): bool
    {
        return $adminUser->can('view_hall');
    }
    ...
    {
        return $adminUser->can('create_hall');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Hall $hall): bool
    {
        return $adminUser->can('update_hall');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Hall $hall): bool
    {
        return $adminUser->can('delete_hall');
    }
    ...
    {
        return $adminUser->can('delete_any_hall');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, Hall $hall): bool
    {
        return $adminUser->can('force_delete_hall');
    }
    ...
    {
        return $adminUser->can('force_delete_any_hall');
    }

    /**
     * Determine whether the adminUser can restore.
     */
    public function restore(AdminUser $adminUser, Hall $hall): bool
    {
        return $adminUser->can('restore_hall');
    }
    ...
    {
        return $adminUser->can('restore_any_hall');
    }

    /**
     * Determine whether the adminUser can replicate.
     */
    public function replicate(AdminUser $adminUser, Hall $hall): bool
    {
        return $adminUser->can('replicate_hall');
    }
    ...
    {
        return $adminUser->can('reorder_hall');
    }
}
