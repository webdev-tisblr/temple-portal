            ...
            <div class="card-sacred p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-xs text-amber-600 mb-0.5">{{ __('store.address') }}</p>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-xs text-amber-600 mb-0.5">{{ __('store.phone') }}</p>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-xs text-amber-600 mb-0.5">{{ __('common.email') }}</p>
